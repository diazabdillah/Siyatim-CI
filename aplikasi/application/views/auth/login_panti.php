...
<head>
    ...
    <title>Masuk Akun Pengurus Panti | Siyatim</title>
    <link rel="icon" 
      type="image/png" 
                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="h5 modal-title text-center">
                                        ...
                                        <h4 class="mt-2">
                                            <div>Selamat datang Pengurus Panti,</div>
                                            <span>Silahkan login menggunakan akun anda.</span>
                                        </h4>
                                    </div>
                                    <?= $this->session->flashdata('message'); ?>
                                    <form class=""action="<?= base_url() ?>panti/login" method="POST">
                                        <div class="form-row">
                                            <div class="col-md-12">
                                                <div class="position-relative form-group"><input autofocus required name="email"
                                            ...
                                            <div class="col-md-12">
                                                <div class="position-relative form-group"><input required name="password"
