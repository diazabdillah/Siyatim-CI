            ...
            <section id="kanan"
                ...
                <div id="input" class="mx-auto col-sm-12 col-md-10 col-lg-9">
                    ...
                    <img class="logo" src="<?= base_url()?>assets/template/custom_siyatim/login_dan_register/img/logo.png" alt="Logo Siyatim" height="150px">
                        <span class="d-block">Lupa password anda?</span>
                        <span>Silahkan masukkan email.</span></h4>                    
                    <div class="dropdown-divider"></div>
                    <form action="<?= base_url('donatur/resetPassword')?>" method="POST">
                        <div class="form-row">
                            <div class="col-md-12">
                                <div class="position-relative form-group"><label for="exampleEmail"
                                        class="">Email</label>
                                        <input required autofocus name="email" id="exampleEmail"
                                        placeholder="Email anda..." type="email" class="form-control">
