        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?= base_url('admin/dashboard/data-panti') ?>">Pengaturan</a></li>
              <li class="breadcrumb-item active"><?= $this->session->userdata('nama_admin') ?></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body box-profile">
                <div class="text-center">
                  <img class="profile-user-img img-fluid img-circle"
                       src="<?= base_url() ?>assets/img/admin/foto-profil/<?= $admin['foto'] ?>"
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <form method="POST"  enctype="multipart/form-data" action="<?= base_url() ?>admin/dashboard/ganti-foto" class="form-horizontal">
                    
                    <input required type="text" hidden name="foto-lama" value="<?= $admin['foto']?>">
                    <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label">Foto Profil</label>                                                               
                        <div class="col-sm-10 text-center">                          
                          <a href="<?= base_url() ?>assets/img/admin/foto-profil/<?= $admin['foto'] ?>" data-toggle="lightbox" data-title="Foto Profil <?= $admin['nama'] ?>" data-gallery="gallery">
                            <img src="<?= base_url() ?>assets/img/admin/foto-profil/<?= $admin['foto'] ?>" class="img-fluid mb-2" width="300px" height="300px" alt="black sample"/>
                          </a>   
                        </div>                                                
                    </div>
                    <div class="form-group row">
                  ...
                  <form method="POST" action="<?= base_url() ?>admin/dashboard/pengaturan" class="form-horizontal">                                       
                    <div class="form-group row">
