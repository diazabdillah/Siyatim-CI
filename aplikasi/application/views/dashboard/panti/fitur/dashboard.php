    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Dashboard Panti Asuhan</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="<?= base_url('panti/dashboard') ?>">Home</a></li>
                <li class="breadcrumb-item"><a href="<?= base_url('panti/dashboard') ?>">Dashboard Panti Asuhan</a></li>
            ...
            <div class="col-md-3">
              ...
              <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                  ...
                  <a target="_blank" href="<?= base_url() ?>panti-asuhan/<?= $panti['id_panti'] ?>" class="btn btn-info btn-block"><small><i class="fas fa-eye mr-1"></i></small>Lihat Halaman Panti</a>
              ...
              <div class="card">
                <div class="card-header p-2">
                  <ul class="nav nav-pills">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#pengaturan" data-toggle="tab">Ganti Password</a></li>
                  </ul>
                </div><!-- /.card-header -->
                <div class="card-body">
                  <div class="tab-content">
                  <div class="tab-pane" id="pengaturan">
                  <form method="POST" action="<?= base_url() ?>panti/dashboard/ganti-password" class="form-horizontal">                                       
                    ...
                    <div class="tab-pane" id="pelaporan">
                      ...
                      <?= form_error('bukti-transfer', '<small class="text-danger pl-3">', '</small>') ?>
                        <?php foreach($bulan as $bln): ?>
                          ...
                          <?php if(count($bln) != 7 || $bln['file_laporan_panti']==""): ?>                          
                          ...
                          <div class="timeline-item">
                            ...
                            <span class="text-danger">Untuk mengupload laporan pada bulan ini, menunggu transfer dari SIYATIM.</span>                              
                          ...
                          <div class="timeline-item">
                            ...
                            <?php if($bln['file_laporan_panti'] == ""): ?>
                              ...
                              <div class="timeline-body">
                                <span class="text-danger">Panti anda belum mengupload laporan keuangan pada bulan ini. Silahkan upload :</span>  
                                <form enctype="multipart/form-data" method="POST" action="<?= base_url('panti/dashboard/upload-laporan')?>">
                                  <div class="custom-file mt-1">                                  
                                    <input required type="text" hidden name="id-panti" value="<?= $panti['id_panti'] ?>">
                                    <input type="text" name="bulan-tahun" value="<?= $bln['bulan_tahun'] ?>" hidden>
                                    <input required name="laporan-panti" type="file" class="custom-file-input" id="customFile">                                          
                                    <label class="custom-file-label" for="customFile">Pilih file laporan (.xls/.xlsx)</label>
                                    <button type="submit"  class="btn btn-sm btn-info mt-2 mb-3"><i class="fas fa-file-upload mr-1"></i>Upload</button>                                                                
                            ...
                            <div class="timeline-footer">
                              <a target="_blank" href="<?= base_url() ?>assets/file/panti/laporan-keuangan/<?= $bln['file_laporan_panti'] ?>" class="btn btn-info btn-sm"><i class="fas fa-cloud-download-alt mr-1"></i>Download (.xls/.xlsx)</a>
                              </div>
                            <?php endif ?>
                          </div>
                        </div>
                  ...
                  <table id="example1" class="text-center table table-bordered table-striped">
                      ...
                      <tr>      
                        ...
                        <td class="text-success">Rp. <?= number_format($d['pendapatan_panti'],2,",",".");  ?></td>
                        <td class="text-danger">Rp.<?= number_format($d['untuk_platform'],2,",","."); ?></td>                               
                      </tr>     
                      <?php endforeach ?>                          
                      </tbody>
                      <tfoot>
                    ...
                    <div class="tab-pane" id="settings">
                      <form method="POST"  enctype="multipart/form-data" action="<?= base_url() ?>panti/dashboard/" class="form-horizontal">
