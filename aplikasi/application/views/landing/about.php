    ...
    <section class="py-5 bg-image overlay-primary fixed overlay" id="next-section" style="background-image: url('https://siyatim.com/masjid3.jpg');">
      <div class="container">
        <div class="row mb-5 justify-content-center">
          <div class="col-md-7 text-center">
            <h2 class="section-title mb-2 text-white">Statistik Panti Asuhan di Indonesia</h2>
        ...
        <div class="row align-items-center">
          <div class="col-lg-6 mb-5 mb-lg-0">
            <a data-fancybox data-ratio="2" href="https://vimeo.com/317571768" class="block__96788">
              ...
              <img src="<?= base_url() ?>assets/template/jobboard/images/sq_img_6.jpg" alt="Image" class="img-fluid img-shadow">
            </a>
          </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 mb-5 mb-lg-0 order-md-2">
            <a data-fancybox data-ratio="2" href="https://vimeo.com/317571768" class="block__96788">
              <span class="play-icon"><span class="icon-play"></span></span>
              <img src="<?= base_url() ?>assets/template/jobboard/images/sq_img_8.jpg" alt="Image" class="img-fluid img-shadow">
            </a>
          </div>
    ...
    <section class="site-section">
      <div class="container">
        ...
        <div class="row align-items-center block__69944">
          ...
          <div class="col-md-6">
            <img src="<?= base_url() ?>assets/template/jobboard/images/person_6.jpg" alt="Image" class="img-fluid mb-4 rounded">
          </div>
          ...
          <div class="col-md-6 order-md-2 ml-md-auto">
            <img src="<?= base_url() ?>assets/template/jobboard/images/person_5.jpg" alt="Image" class="img-fluid mb-4 rounded">
          </div>
