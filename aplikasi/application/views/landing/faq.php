    ...
    <section class="site-section" id="accordion">
      <div class="container">
        ...
        <div class="row accordion justify-content-center block__76208">
          <div class="col-lg-6">
            <img src="<?= base_url() ?>/assets/img/android-chrome-512x512.png" alt="Image" class="img-fluid rounded">
          </div>
          <div class="col-lg-5 ml-auto">
            <div class="accordion-item">
              <h3 class="mb-0 heading">
                <a class="btn-block h4" data-toggle="collapse" href="#collapseFive" role="button" aria-expanded="true" aria-controls="collapseFive">Apa itu Si Yatim?<span class="icon"></span></a>
              </h3>
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="block__87154 bg-white rounded">
              ...
              <div class="block__91147 d-flex align-items-center">
                <figure class="mr-4"><img src="<?= base_url() ?>assets/template/jobboard/images/person_1.jpg" alt="Image" class="img-fluid"></figure>
                <div>
          ...
          <div class="col-lg-6">
            <div class="block__87154 bg-white rounded">
              ...
              <div class="block__91147 d-flex align-items-center">
                <figure class="mr-4"><img src="<?= base_url() ?>assets/template/jobboard/images/person_2.jpg" alt="Image" class="img-fluid"></figure>
                <div>
                  <h3>Chris Peter</h3>
