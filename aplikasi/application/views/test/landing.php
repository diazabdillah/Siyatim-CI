...
<head>
	...
	<link rel="stylesheet" href="<?= base_url('assets') ?>/umum/css/linearicons.css">
	<link rel="stylesheet" href="<?= base_url('assets') ?>/umum/css/font-awesome.min.css">
	<link rel="stylesheet" href="<?= base_url('assets') ?>/umum/css/bootstrap.css">
	<link rel="stylesheet" href="<?= base_url('assets') ?>/umum/css/magnific-popup.css">
	<link rel="stylesheet" href="<?= base_url('assets') ?>/umum/css/nice-select.css">
	<link rel="stylesheet" href="<?= base_url('assets') ?>/umum/css/animate.min.css">
	<link rel="stylesheet" href="<?= base_url('assets') ?>/umum/css/owl.carousel.css">
	<link rel="stylesheet" href="<?= base_url('assets') ?>/umum/css/main.css">
</head>
...
<body>
	...
	<header id="header">
		<div class="container">
			<div class="row align-items-center justify-content-between d-flex">
				<div id="logo">
					<a href="index.html"><img src="<?= base_url('assets') ?>/umum/img/logo.png" alt="" title="" /></a>
				</div>
	...
	<section class="home-banner-area relative">
		<div class="container">
			<div class="row fullscreen d-flex align-items-center justify-content-center">
				<div class="banner-content col-lg-8 col-md-12">
					<h1 class="wow fadeIn" data-wow-duration="4s">Sedekah membuat berkah</h1>
					<p class="text-white">
					...
					<div class="input-wrap">
						<form action="" class="form-box d-flex justify-content-between">
							<input type="text" placeholder="Cari Panti Asuhan..." class="form-control" name="username">
							<button type="submit" class="btn search-btn">Pencarian</button>
						</form>
					</div>
					<h4 class="text-white">Pencarian Teratas</h4>
		...
		<div class="rocket-img">
			<img src="<?= base_url('assets') ?>/umum/img/rocket.png" alt="">
		</div>
	</section>
	<!-- End Banner Area -->
		...
		<div class="container">
			<div class="row align-items-center justify-content-center">
				<div class="col-lg-5 col-md-6 about-left">
					<img class="img-fluid" src="<?= base_url('assets') ?>/umum/img/about.jpg" alt="">
				</div>
				<div class="offset-lg-1 col-lg-6 offset-md-0 col-md-12 about-right">
					<h1>
						Sebanyak 2500 Panti <br> Telah Bergabung
					</h1>
					...
					<a href="courses.html" class="primary-btn">Explore Panti</a>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-5 about-right">
					<h1>
						Inilah Keutamaan <br> Sedekah ke Anak Yatim
					</h1>
					<div class="wow fadeIn" data-wow-duration="1s">
						<p>
							There is a moment in the life of any aspiring astronomer that it is time to buy that first telescope. It’s exciting to think
					...
					<a href="courses.html" class="primary-btn white">Explore Panti</a>
				</div>
			...
			<div class="row justify-content-center d-flex align-items-center">
				<div class="col-lg-3 col-md-6 col-sm-12 single-faculty">
					<div class="thumb d-flex justify-content-center">
						<img class="img-fluid" src="<?= base_url('assets') ?>/umum/img/faculty/f1.jpg" alt="">
					</div>
				...
				<div class="col-lg-3 col-md-6 col-sm-12 single-faculty">
					<div class="thumb d-flex justify-content-center">
						<img class="img-fluid" src="<?= base_url('assets') ?>/umum/img/faculty/f2.jpg" alt="">
					</div>
					<div class="meta-text text-center">
						<h4>Rodney Cooper</h4>
						<p class="designation">Sr. Faculty Data Science</p>
				...
				<div class="col-lg-3 col-md-6 col-sm-12 single-faculty">
					<div class="thumb d-flex justify-content-center">
						<img class="img-fluid" src="<?= base_url('assets') ?>/umum/img/faculty/f3.jpg" alt="">
					</div>
					<div class="meta-text text-center">
						<h4>Dora Walker</h4>
						<p class="designation">Sr. Faculty Data Science</p>
				...
				<div class="col-lg-3 col-md-6 col-sm-12 single-faculty">
					<div class="thumb d-flex justify-content-center">
						<img class="img-fluid" src="<?= base_url('assets') ?>/umum/img/faculty/f4.jpg" alt="">
					</div>
					<div class="meta-text text-center">
						<h4>Lena Keller</h4>
						<p class="designation">Sr. Faculty Data Science</p>
		...
		<div class="container">
			<div class="testi-slider owl-carousel" data-slider-id="1">
				<div class="item">
					<div class="testi-item">
						<img src="<?= base_url('assets') ?>/umum/img/quote.png" alt="">
						<h4>Fanny Spencer</h4>
						<ul class="list">
			...
			<div class="owl-thumbs d-flex justify-content-center" data-slider-id="1">
				<div class="owl-thumb-item">
					<div>
						<img class="img-fluid" src="<?= base_url('assets') ?>/umum/img/testimonial/t1.jpg" alt="">
					</div>
					<div class="overlay overlay-grad"></div>
				</div>
				<div class="owl-thumb-item">
					<div>
						<img class="img-fluid" src="<?= base_url('assets') ?>/umum/img/testimonial/t2.jpg" alt="">
					</div>
					<div class="overlay overlay-grad"></div>
				</div>
				<div class="owl-thumb-item">
					<div>
						<img class="img-fluid" src="<?= base_url('assets') ?>/umum/img/testimonial/t3.jpg" alt="">
					</div>
					<div class="overlay overlay-grad"></div>
				</div>
				<div class="owl-thumb-item">
					<div>
						<img class="img-fluid" src="<?= base_url('assets') ?>/umum/img/testimonial/t4.jpg" alt="">
					</div>
					<div class="overlay overlay-grad"></div>
				</div>
			</div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
	...
	<script src="<?= base_url('assets') ?>/umum/js/vendor/jquery-2.2.4.min.js"></script>
	<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js" integrity="sha384-ApNbgh9B+Y1QKtv3Rn7W3mgPxhU9K/ScQsAP7hUibX39j7fakFPskvXusvfa0b4Q"
	 crossorigin="anonymous"></script>
	<script src="<?= base_url('assets') ?>/umum/js/vendor/bootstrap.min.js"></script>
	<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBhOdIF3Y9382fqJYt5I_sswSrEw5eihAA"></script>
	<script src="<?= base_url('assets') ?>/umum/js/easing.min.js"></script>
	<script src="<?= base_url('assets') ?>/umum/js/hoverIntent.js"></script>
	<script src="<?= base_url('assets') ?>/umum/js/superfish.min.js"></script>
	<script src="<?= base_url('assets') ?>/umum/js/jquery.ajaxchimp.min.js"></script>
	<script src="<?= base_url('assets') ?>/umum/js/jquery.magnific-popup.min.js"></script>
	<script src="<?= base_url('assets') ?>/umum/js/owl.carousel.min.js"></script>
	<script src="<?= base_url('assets') ?>/umum/js/owl-carousel-thumb.min.js"></script>
	<script src="<?= base_url('assets') ?>/umum/js/jquery.sticky.js"></script>
	<script src="<?= base_url('assets') ?>/umum/js/jquery.nice-select.min.js"></script>
	<script src="<?= base_url('assets') ?>/umum/js/parallax.min.js"></script>
	<script src="<?= base_url('assets') ?>/umum/js/waypoints.min.js"></script>
	<script src="<?= base_url('assets') ?>/umum/js/wow.min.js"></script>
	<script src="<?= base_url('assets') ?>/umum/js/jquery.counterup.min.js"></script>
	<script src="<?= base_url('assets') ?>/umum/js/mail-script.js"></script>
	<script src="<?= base_url('assets') ?>/umum/js/main.js"></script>
</body>
